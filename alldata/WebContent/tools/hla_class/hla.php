<?php
  ...
  $pstatus = proc_get_status($process);
	...
	$resfile =  "/tools/hla_class/tmp/" . array_pop(explode("/", $_SESSION["results"]));
	$detfile =  "/tools/hla_class/tmp/" . array_pop(explode("/", $_SESSION["details"]));
	$techerrfile = "/tools/hla_class/tmp/" . array_pop(explode("/", $_SESSION["tech_errors"]));
	$errfile = "/tools/hla_class/tmp/" . array_pop(explode("/", $_SESSION["errors"]));
