...
##print ( "Quick Results, DNA: <br>" )

# Format and print console output.
#index = 0
for key, value in list( dna_sequences_dict.iteritems() ):
	#index += 1
...
##print ( "<br>Quick Results, Amino Acid: <br>" )

#index = 0
# Format and print console output.
for key, value in list( amino_acid_sequences_dict.iteritems() ):
	#index += 1
	#sequence_id = index  # The sequence number.
	repetitions = len(value)
	#identical_sequence_list = value  # This list holds all the names of identical sequences.
...
index = 0
for key, value in list( sorted(dna_sequences_dict.iteritems(), key=lambda (k,v): (-len(v),k)) ):
	index += 1
	sequence_id = index  # The sequence number.
	repetitions = len(value)
	identical_sequence_list = value  # This list holds all the names of identical sequences.
...
# Create data row information.
index = 0
for key, value in list( sorted(amino_acid_sequences_dict.iteritems(), key=lambda (k,v): (-len(v),k)) ):
	index += 1
	sequence_id = index  # The sequence number.
	repetitions = len(value)
	identical_sequence_list = value  # This list holds all the names of identical sequences.
