...
##This has been checked for python 3.6##
...
def seq_stop_test(in_sequence):
	...
	The length of in_sequence must be divisible by 3 before running this function.
	'''
...
def seq_internal_test(in_sequence):
	...
	Internal codons are in single quotes ex:
	ATC 'CTG' CGT, or
	ATC 'CTG' G (incomplete end codon.)
	'''
	endpoint = -1 if len(in_sequence) % 3 == 0 else None 
